...
export default function Heatmap({ sensorData, devices }) {
  ...
  // NEW: store popup root for real-time updates
    ...
    map.current.on("load", () => {
      if (map.current.getSource("heatmap-source")) {
        ...
        map.current.on("mouseenter", "sensor-points", (e) => {
          ...
          // store root so useEffect can re-render with new readings
          popupRootRef.current = { root, coords: coordinates }
  ...
  // NEW: live update popup when sensorData changes
  useEffect(() => {
    if (popupRootRef.current && sensorData) {
